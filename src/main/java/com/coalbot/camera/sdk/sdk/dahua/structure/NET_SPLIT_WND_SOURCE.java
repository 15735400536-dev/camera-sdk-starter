 ...
 * 窗口显示源信息
*/
public class NET_SPLIT_WND_SOURCE extends NetSDKLibStructure.SdkStructure
{
    public int              dwSize;
    /**
     * 显示源是否有效
    ...
    */
    ...
    /**
     * 远程设备信息,参见结构体定义 {@link NetSDKLibStructure.NET_REMOTE_DEVICE}
    */
    public NetSDKLibStructure.NET_REMOTE_DEVICE stuRemoteDevice = new NetSDKLibStructure.NET_REMOTE_DEVICE();
    /**
     * 视频源区域,若区域为(0,0,0,0)表示数据无效，设备使用默认值(0,0,8192,8192),参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_RECT}
    */
