...
public class TargetRecognitionModule {
	 ...
	 */
	public static NetSDKLibStructure.NET_FACERECONGNITION_GROUP_INFO[] findGroupInfo(String groupId) {
		NetSDKLibStructure.NET_FACERECONGNITION_GROUP_INFO[] groupInfoRet = null;
		
		/*
		 * 入参
		 */
		NetSDKLibStructure.NET_IN_FIND_GROUP_INFO stuIn = new NetSDKLibStructure.NET_IN_FIND_GROUP_INFO();
		 ...
		 */
		int max = 20;
		NetSDKLibStructure.NET_FACERECONGNITION_GROUP_INFO[] groupInfo  = new NetSDKLibStructure.NET_FACERECONGNITION_GROUP_INFO[max];
		for(int i = 0; i < max; i++) {
			groupInfo[i] = new NetSDKLibStructure.NET_FACERECONGNITION_GROUP_INFO();
		}
		
		NetSDKLibStructure.NET_OUT_FIND_GROUP_INFO stuOut = new NetSDKLibStructure.NET_OUT_FIND_GROUP_INFO();
		...
		if(LoginModule.netsdk.CLIENT_FindGroupInfo(LoginModule.m_hLoginHandle, stuIn, stuOut, 4000)) {
			...
			if(stuOut.nRetGroupNum > 0) {
				// 根据设备返回的，将有效的人脸库信息返回
				groupInfoRet = new NetSDKLibStructure.NET_FACERECONGNITION_GROUP_INFO[stuOut.nRetGroupNum];
	...
	public static boolean addGroup(String groupName) {
		NetSDKLibStructure.NET_ADD_FACERECONGNITION_GROUP_INFO addGroupInfo = new NetSDKLibStructure.NET_ADD_FACERECONGNITION_GROUP_INFO();
		 ...
		 * 入参
		 */
		NetSDKLibStructure.NET_IN_OPERATE_FACERECONGNITION_GROUP stuIn = new NetSDKLibStructure.NET_IN_OPERATE_FACERECONGNITION_GROUP();
		stuIn.emOperateType = NetSDKLibStructure.EM_OPERATE_FACERECONGNITION_GROUP_TYPE.NET_FACERECONGNITION_GROUP_ADD; // 添加人员组信息
		stuIn.pOPerateInfo = addGroupInfo.getPointer();		
		
		/*
		 * 出参
		 */
		NetSDKLibStructure.NET_OUT_OPERATE_FACERECONGNITION_GROUP stuOut = new NetSDKLibStructure.NET_OUT_OPERATE_FACERECONGNITION_GROUP();
	...
	public static boolean modifyGroup(String groupName, String groupId) {
		NetSDKLibStructure.NET_MODIFY_FACERECONGNITION_GROUP_INFO modifyGroupInfo = new NetSDKLibStructure.NET_MODIFY_FACERECONGNITION_GROUP_INFO();
		 ...
		 */
		NetSDKLibStructure.NET_IN_OPERATE_FACERECONGNITION_GROUP stuIn = new NetSDKLibStructure.NET_IN_OPERATE_FACERECONGNITION_GROUP();
		stuIn.emOperateType = NetSDKLibStructure.EM_OPERATE_FACERECONGNITION_GROUP_TYPE.NET_FACERECONGNITION_GROUP_MODIFY; // 修改人员组信息
	...
	public static boolean deleteGroup(String groupId) {
		NetSDKLibStructure.NET_DELETE_FACERECONGNITION_GROUP_INFO deleteGroupInfo = new NetSDKLibStructure.NET_DELETE_FACERECONGNITION_GROUP_INFO();
		 ...
		 */
		NetSDKLibStructure.NET_IN_OPERATE_FACERECONGNITION_GROUP stuIn = new NetSDKLibStructure.NET_IN_OPERATE_FACERECONGNITION_GROUP();
		stuIn.emOperateType = NetSDKLibStructure.EM_OPERATE_FACERECONGNITION_GROUP_TYPE.NET_FACERECONGNITION_GROUP_DELETE; // 删除人员组信息
	...
	public static boolean putDisposition(String groupId, HashMap<Integer, Integer> hashMap) {
		 ...
		 * 入参
		 */
		NetSDKLibStructure.NET_IN_FACE_RECOGNITION_PUT_DISPOSITION_INFO stuIn = new NetSDKLibStructure.NET_IN_FACE_RECOGNITION_PUT_DISPOSITION_INFO();
		// 人脸库ID
		System.arraycopy(groupId.getBytes(), 0, stuIn.szGroupId, 0, groupId.getBytes().length);
		 ...
		 * 出参
		 */
		NetSDKLibStructure.NET_OUT_FACE_RECOGNITION_PUT_DISPOSITION_INFO stuOut = new NetSDKLibStructure.NET_OUT_FACE_RECOGNITION_PUT_DISPOSITION_INFO();
	...
	public static boolean delDisposition(String groupId, ArrayList<Integer> arrayList) {
		 ...
		 * 入参
		 */
		NetSDKLibStructure.NET_IN_FACE_RECOGNITION_DEL_DISPOSITION_INFO stuIn = new NetSDKLibStructure.NET_IN_FACE_RECOGNITION_DEL_DISPOSITION_INFO();
		 ...
		 *  出参
		 */
		NetSDKLibStructure.NET_OUT_FACE_RECOGNITION_DEL_DISPOSITION_INFO stuOut = new NetSDKLibStructure.NET_OUT_FACE_RECOGNITION_DEL_DISPOSITION_INFO();
	...
	public static void GetGroupInfoForChannel(int channel) {
		 ...
		 * 入参
		 */
		NetSDKLibStructure.NET_IN_GET_GROUPINFO_FOR_CHANNEL stIn = new NetSDKLibStructure.NET_IN_GET_GROUPINFO_FOR_CHANNEL();
		 ...
		 * 出参
		 */
		NetSDKLibStructure.NET_OUT_GET_GROUPINFO_FOR_CHANNEL stOut = new NetSDKLibStructure.NET_OUT_GET_GROUPINFO_FOR_CHANNEL();
	...
	public static void SetGroupInfoForChannel(int channel, String[] groupIds, int[] similarys) {
		 ...
		 * 入参
		 */
		NetSDKLibStructure.NET_IN_SET_GROUPINFO_FOR_CHANNEL stIn = new NetSDKLibStructure.NET_IN_SET_GROUPINFO_FOR_CHANNEL();
	...
	public static int startFindPerson(String groupId, 
		...
		stuIn.stFilterInfo.szRange[0] = NetSDKLibStructure.EM_FACE_DB_TYPE.NET_FACE_DB_TYPE_BLACKLIST;
	 ...
	 * @return 返回的人员信息数组
	 */
	public static NetSDKLibStructure.CANDIDATE_INFOEX[] doFindPerson(int beginNum, int nCount) {
    	/*
    	 *入参
    	 */
	...
	public static boolean addPerson(String groupId, 
		 ...
		 *  入参
		 */
		NetSDKLibStructure.NET_IN_OPERATE_FACERECONGNITIONDB stuIn  = new NetSDKLibStructure.NET_IN_OPERATE_FACERECONGNITIONDB();
		stuIn.emOperateType = NetSDKLibStructure.EM_OPERATE_FACERECONGNITIONDB_TYPE.NET_FACERECONGNITIONDB_ADD;
		 ...
		 * 出参
		 */
		NetSDKLibStructure.NET_OUT_OPERATE_FACERECONGNITIONDB stuOut = new NetSDKLibStructure.NET_OUT_OPERATE_FACERECONGNITIONDB() ;
	...
	public static boolean modifyPerson(String groupId, 
		...
		// 入参
		NetSDKLibStructure.NET_IN_OPERATE_FACERECONGNITIONDB stuIn  = new NetSDKLibStructure.NET_IN_OPERATE_FACERECONGNITIONDB();
		stuIn.emOperateType = NetSDKLibStructure.EM_OPERATE_FACERECONGNITIONDB_TYPE.NET_FACERECONGNITIONDB_MODIFY;
	...
	public static boolean delPerson(String groupId, String sUID) {    
		 ...
		 */
		NetSDKLibStructure.NET_IN_OPERATE_FACERECONGNITIONDB stuIn  = new NetSDKLibStructure.NET_IN_OPERATE_FACERECONGNITIONDB();
		stuIn.emOperateType = NetSDKLibStructure.EM_OPERATE_FACERECONGNITIONDB_TYPE.NET_FACERECONGNITIONDB_DELETE;
	...
	public static boolean downloadPersonPic(String szFileName, String pszFileDst) {
		 ...
		 * 入参
		 */
		NetSDKLibStructure.NET_IN_DOWNLOAD_REMOTE_FILE stuIn = new NetSDKLibStructure.NET_IN_DOWNLOAD_REMOTE_FILE();
		// 需要下载的文件名
		 ...
		 * 出参
		 */
		NetSDKLibStructure.NET_OUT_DOWNLOAD_REMOTE_FILE stuOut = new NetSDKLibStructure.NET_OUT_DOWNLOAD_REMOTE_FILE();
	...
	public static boolean findFile(int nChn, String startTime, String endTime) {
		int type = NetSDKLibStructure.EM_FILE_QUERY_TYPE.NET_FILE_QUERY_FACE;

		/**
		 *  查询条件
		 */
		NetSDKLibStructure.MEDIAFILE_FACERECOGNITION_PARAM findContion = new NetSDKLibStructure.MEDIAFILE_FACERECOGNITION_PARAM();
...
//		System.arraycopy(groupId.getBytes(), 0, findContion.stPersonInfoEx.szGroupID, 0, groupId.getBytes().length);
	...
	public static NetSDKLibStructure.MEDIAFILE_FACERECOGNITION_INFO[] findNextFile(int nFindCount) {
		...
		NetSDKLibStructure.MEDIAFILE_FACERECOGNITION_INFO[] retInfo = new NetSDKLibStructure.MEDIAFILE_FACERECOGNITION_INFO[nRetCount];
		for (int i = 0; i < retInfo.length; ++i) {
			retInfo[i] = new NetSDKLibStructure.MEDIAFILE_FACERECOGNITION_INFO();
			retInfo[i] = msg[i];
		}
