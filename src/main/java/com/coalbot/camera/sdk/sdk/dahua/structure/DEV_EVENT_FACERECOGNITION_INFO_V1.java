 ...
 * @date 2022/05/23
 */
public class DEV_EVENT_FACERECOGNITION_INFO_V1 extends NetSDKLibStructure.SdkStructure {
    ...
    public NetSDKLibStructure.NET_PIC_INFO     stuGlobalScenePicInfo;                // 全景图片信息
    public byte[]           szSnapDevAddress = new byte[NetSDKLibStructure.MAX_PATH]; // 抓拍当前人脸的设备地址,如：滨康路37号
    ...
    public NetSDKLibStructure.NET_FACE_DATA    stuFaceData;                          // 人脸数据
    public byte[]           szUID = new byte[NetSDKLibStructure.NET_COMMON_STRING_32]; // 抓拍人员写入数据库的唯一标识符
    public NetSDKLibStructure.NET_FEATURE_VECTOR stuFeatureVector;                   // 特征值信息
    ...
    public NetSDKLibStructure.NET_PASSERBY_INFO stuPasserbyInfo;                     // 路人库信息
    ...
    public	NetSDKLibStructure.SCENE_IMAGE_INFO stuThumImageInfo = new NetSDKLibStructure.SCENE_IMAGE_INFO(); //大图（全景图）的缩略图信息
    public	NetSDKLibStructure.SCENE_IMAGE_INFO stuHumanImageInfo = new NetSDKLibStructure.SCENE_IMAGE_INFO(); //人体图片信息
