...
*/
public class DEV_EVENT_CONVEYER_BELT_BULK_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 通道号
    */
    ...
    */
    public NetSDKLibStructure.NET_POINT[] stuDetectLine = new NetSDKLibStructure.NET_POINT[20];
    /**
     * 事件ID
    */
    public int              nEventID;
    ...
    */
    ...
    /**
     * 检测到的物体信息,参见结构体定义 {@link NetSDKLibStructure.NET_MSG_OBJECT}
    */
    public NetSDKLibStructure.NET_MSG_OBJECT[] stuObjects = new NetSDKLibStructure.NET_MSG_OBJECT[20];
    /**
     * 全景广角图信息,参见结构体定义 {@link NetSDKLibStructure.SCENE_IMAGE_INFO_EX}
    */
    ...
    */
    ...
    public DEV_EVENT_CONVEYER_BELT_BULK_INFO() {
        for(int i = 0; i < stuDetectLine.length; i++){
            stuDetectLine[i] = new NetSDKLibStructure.NET_POINT();
        }
