...
*/
public class NET_DEV_EVENT_GROUND_THING_DETECTION_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 通道号
    */
    ...
    */
    ...
    /**
     * 单目标小图分割结果,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_GROUND_THING_DETECTION_MASK_INFO}
    */
    public NET_GROUND_THING_DETECTION_MASK_INFO[] stuMaskInfo = new NET_GROUND_THING_DETECTION_MASK_INFO[64];
    /**
     * mask输出信息类型映射,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_GROUND_THING_DETECTION_MAP_INFO}
    */
    public NET_GROUND_THING_DETECTION_MAP_INFO[] stuMapInfo = new NET_GROUND_THING_DETECTION_MAP_INFO[256];
    /**
     * 上报原图,参见结构体定义 {@link NetSDKLibStructure.SCENE_IMAGE_INFO}
    */
