 ...
 * 船只物体信息扩展
*/
public class NET_BOAT_OBJECT_EXTERN extends NetSDKLibStructure.SdkStructure
{
    /**
     * AIS融合目标信息,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_AIS_FUSE_OBJECT}
    */
    public NET_AIS_FUSE_OBJECT stuAISFuseObject = new NET_AIS_FUSE_OBJECT();
    /**
     * AIS融合目标信息扩展,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_AIS_FUSE_OBJECT_EX}
    */
