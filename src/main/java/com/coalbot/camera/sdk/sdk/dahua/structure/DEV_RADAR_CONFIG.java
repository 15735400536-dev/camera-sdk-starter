 ...
 * @version v1.0
 */
public class DEV_RADAR_CONFIG extends NetSDKLibStructure.SdkStructure {
    ...
    */
    ...
    /**
     * 川速雷达配置,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_TRANS_RADAR_CONFIG}
    */
    public NET_TRANS_RADAR_CONFIG stuTransRadarConfig = new NET_TRANS_RADAR_CONFIG();
    /**
     * 纳雷雷达配置,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_NALEI_RADAR_CONFIG}
    */
    ...
    */
    ...
    /**
     * 速度修正,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_RADAR_SPEED_MODIFY}
    */
    ...
    */
    ...
    /**
     * 雷达速度修正配置,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_RADAR_SPEED_CORRECTION}
    */
