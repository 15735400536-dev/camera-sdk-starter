 ...
 */
public class NET_SPLIT_OSD extends NetSDKLibStructure.SdkStructure {
    public int              dwSize;
	/**
	 * 使能
	 */
	 ...
	 * 前景区域
	 */
    public NetSDKLibStructure.DH_RECT stuFrontRect = new NetSDKLibStructure.DH_RECT();
	/**
	 * 背景区域
	 */
    public NetSDKLibStructure.DH_RECT stuBackRect = new NetSDKLibStructure.DH_RECT();
	/**
	 * 是否滚动显示, 只对文本有效
	 */
    public int              bRoll;
