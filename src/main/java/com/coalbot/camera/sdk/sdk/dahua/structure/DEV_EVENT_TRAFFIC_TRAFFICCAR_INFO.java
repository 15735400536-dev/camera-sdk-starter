 ...
 */
public class DEV_EVENT_TRAFFIC_TRAFFICCAR_INFO extends NetSDKLibStructure.SdkStructure {
    /**
     * 车牌号码
     */
    ...
    /**
     * 车辆行驶方向 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_TRAFFICCAR_MOVE_DIRECTION}
     */
     ...
     * 允许名单信息
     */
    public NetSDKLibStructure.NET_TRAFFICCAR_WHITE_LIST stuWhiteList = new NetSDKLibStructure.NET_TRAFFICCAR_WHITE_LIST();
    /**
     * 车辆类型 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_TRAFFICCAR_CAR_TYPE}
     */
    public int              emCarType;
    /**
     * 车道类型 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_TRAFFICCAR_LANE_TYPE}
     */
     ...
     * 禁止名单信息
     */
    public NetSDKLibStructure.NET_TRAFFICCAR_BLACK_LIST stuBlackList = new NetSDKLibStructure.NET_TRAFFICCAR_BLACK_LIST();
    /**
     * 车流量方向 {@link NetSDKLibStructure.EM_VEHICLE_DIRECTION}
     */
    public int              emFlowDirection;
    /**
     * 收费公路车辆通行费车型分类 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_TOLLS_VEHICLE_TYPE}
     */
    ...
    /**
     * 车牌属性 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_PLATE_ATTRIBUTE}
     */
    public int              emPlateAttribute;
    /**
     * 交通车辆信息扩展, refer to {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_TRAFFICCAR_INFO_EXTERN}
     */
    ...
    */
     ...
     * 保留字节,留待扩展
     */
    public byte[]           bReserved = new byte[64-NetSDKLibStructure.POINTERSIZE];
}
