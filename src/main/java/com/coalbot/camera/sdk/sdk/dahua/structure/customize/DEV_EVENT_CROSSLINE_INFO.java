 ...
 * {@link NetSDKLibStructure.DEV_EVENT_CROSSLINE_INFO}
 *
 * @author 47040
 * @since Created in 2021/5/13 19:03
 */
public class DEV_EVENT_CROSSLINE_INFO extends NetSDKLibStructure.SdkStructure {
     ...
     * 规则检测线
     */
    public NetSDKLibStructure.NET_POINT[] DetectLine = (NetSDKLibStructure.NET_POINT[]) new NetSDKLibStructure.NET_POINT().toArray(NetSDKLibStructure.NET_MAX_DETECT_LINE_NUM);
    /**
     * 规则检测线顶点数
     */
     ...
     */
    public byte[] szSourceDevice = new byte[NetSDKLibStructure.MAX_PATH];
    /**
