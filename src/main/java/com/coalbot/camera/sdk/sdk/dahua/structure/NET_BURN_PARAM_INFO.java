 ...
 * @version 1.0
 * @description 刻录参数配置
 * 对应枚举{@link com.coalbot.camera.sdk.sdk.dahua.enumeration.NET_EM_CFG_OPERATE_TYPE#NET_EM_CFG_BURN_PARAM}
 * @date 2020/11/10
 */
public class NET_BURN_PARAM_INFO extends NetSDKLibStructure.SdkStructure {
    public int              dwSize;
    /**
     * 有效刻录通道个数
     */
