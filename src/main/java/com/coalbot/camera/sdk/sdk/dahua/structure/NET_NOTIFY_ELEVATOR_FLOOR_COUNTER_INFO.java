 ...
 * 多维度电梯感知信息信息
*/
public class NET_NOTIFY_ELEVATOR_FLOOR_COUNTER_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 梯内当前人数
    */
    ...
    */
    public int              nChannel;
    /**
     * 扩展数据, 内存由NetSDK申请释放,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_NOTIFY_ELEVATOR_FLOOR_COUNTER_EXTDATA_INFO}
    */
