 ...
 * 编排信息
*/
public class NET_FLOWTASK_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 编排Id
    */
    ...
    /**
     * 关联事件数据信息 来源于编排子事件,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_FLOWTASK_LINKNODE}
    */
