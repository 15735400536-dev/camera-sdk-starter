...
/**
 * 事件类型 {@link NetSDKLibStructure#NET_ALARM_REGION_PARKING_NO_ENTRY_RECORD}(区间车位停车,检测到车辆驶出区域时没有匹配到入场信息)
 ...
 */
public class ALARM_REGION_PARKING_NO_ENTRY_RECORD_INFO extends NetSDKLibStructure.SdkStructure {
    /**
     * 0:脉冲
     */
    public int              nAction;
