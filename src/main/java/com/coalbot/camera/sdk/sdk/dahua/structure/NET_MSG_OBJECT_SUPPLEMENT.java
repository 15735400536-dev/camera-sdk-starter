 ...
 */
public class NET_MSG_OBJECT_SUPPLEMENT extends NetSDKLibStructure.SdkStructure {
	/**
	 * 智能物体全局唯一物体标识
	 */
    ...
    */
    ...
    /**
     * 修改时间，指的是平台最近一次修改注册库人员信息的时间,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.NetSDKLibStructure.NET_TIME}
    */
    public NetSDKLibStructure.NET_TIME stuModifyTime = new NetSDKLibStructure.NET_TIME();
    /**
     * 注册库入库时间,参见结构体定义 {@link NetSDKLibStructure.NET_TIME}
    */
