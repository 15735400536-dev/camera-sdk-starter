...
*/
public class NET_DEV_EVENT_ELEVATOR_WORK_INFO_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 通道号
    */
    ...
    */
    public NetSDKLibStructure.VA_OBJECT_NONMOTOR[] stuNonMotor = new NetSDKLibStructure.VA_OBJECT_NONMOTOR[8];
    /**
    ...
    */
    ...
    public NET_DEV_EVENT_ELEVATOR_WORK_INFO_INFO() {
        for(int i = 0; i < stuNonMotor.length; i++){
            stuNonMotor[i] = new NetSDKLibStructure.VA_OBJECT_NONMOTOR();
        }
    }
}
