 ...
 */
public class CGF_MASKING_INFO extends NetSDKLibStructure.SdkStructure {
    /**
     ...
     *  多边形顶点坐标,坐标取值0~8192
     */
    public NetSDKLibStructure.CFG_POLYGON[] stuPolygon = (NetSDKLibStructure.CFG_POLYGON[]) new NetSDKLibStructure.CFG_POLYGON().toArray(NetSDKLibStructure.MAX_POLYGON_NUM);
    /**
     *  遮挡块色
     */
    public NetSDKLibStructure.NET_CFG_Color stuColor;
    /**
	...
	public CGF_MASKING_INFO() {
		for (int i = 0; i < stuPolygon.length; i++) {
			stuPolygon[i] = new NetSDKLibStructure.CFG_POLYGON();
		}
	}
}
