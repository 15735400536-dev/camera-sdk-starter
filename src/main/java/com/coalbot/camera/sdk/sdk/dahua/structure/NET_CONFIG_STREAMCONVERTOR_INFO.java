 ...
 * @date 2021/3/2
 */
public class NET_CONFIG_STREAMCONVERTOR_INFO extends NetSDKLibStructure.SdkStructure {
  /**
   ...
   */
    public byte[]           szStreamConvertor = new byte[NetSDKLibStructure.MAX_PATH];
  /** 保留字节 */
