 ...
 */
public class NET_OPENDOOR_MATCHINFO_EX extends NetSDKLibStructure.SdkStructure {
    /**
     * 扩展用户名
     */
    public byte[]           szUserNameEx = new byte[128];
    /**
     * 语音类型 (医疗使用) {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_CUSTOM_MEDICAL_VOICE_TYPE}
     */
