 ...
 */
public class DEV_EVENT_DIALRECOGNITION_INFO extends NetSDKLibStructure.SdkStructure {
	/**
	 * 视频通道号,从0开始
	 */
	...
	/**
	 * 仪表类型 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_INSTRUMENT_TYPE}
	 */
    public int              emType;
	/**
	 * 返回的图片信息个数
    ...
    */
    ...
    /**
     * 多个检测到的仪表目标信息，内存由NetSDK申请释放,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_DIAL_OBJECT_INFO}
    */
    ...
    */
	 ...
	 * 预留字节
	 */
    public byte[]           szReserved = new byte[828-NetSDKLibStructure.POINTERSIZE];
