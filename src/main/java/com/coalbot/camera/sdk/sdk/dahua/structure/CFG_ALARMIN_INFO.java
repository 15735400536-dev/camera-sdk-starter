 ...
 */
public class CFG_ALARMIN_INFO extends NetSDKLibStructure.SdkStructure {
    /**
     * / 报警通道号(0开始)
     */
     ...
     */
    public NetSDKLibStructure.CFG_TIME_SECTION[] stuTimeSection = new NetSDKLibStructure.CFG_TIME_SECTION[7 * 6];
    /**
     * /
     */
    public int              abDevID;
    ...
    public int              nPole;
    /**
     * 传感器感应方式 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_SENSE_METHOD}
     */
    public int              emSense;
    /**
     * / 报警使能控制方式 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_CTRL_ENABLE}
     */
    public int              emCtrl;
    /**
    ...
    /**
     * / 防区类型, 具体支持的类型通过查询能力获得 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_CFG_DEFENCEAREATYPE}
     */
