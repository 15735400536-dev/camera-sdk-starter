...
*/
public class MEDIAFILE_NONMOTOR_PARAM extends NetSDKLibStructure.SdkStructure
{
    /**
     * 结构体大小
    */
    ...
    */
    ...
    /**
     * 非机动车颜色,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_NONMOTOR_COLOR}
    */
    public int              emNonmotorColor;
    /**
     * 非机动车子类型,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_NONMOTOR_SUBTYPE}
    */
    public int              emNonmotorSubtype;
    /**
     * 头盔状态,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_HELMET_STATE}
    */
    ...
    */
    ...
    /**
     * UTC开始时间(标准UTC时间), 与stuEndTimeRealUTC配对使用，与(stuStartTime, stuEndTime)互斥,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.NetSDKLibStructure.NET_TIME}
    */
    ...
    */
    ...
    /**
     * 上装颜色,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_NONMOTOR_COLOR}
    */
