 ...
 * 所有传感器的信息
*/
public class NET_IOTBOX_DEVICE_INFO_EX extends NetSDKLibStructure.SdkStructure
{
    /**
     * 传感器通道名称
    */
    ...
    */
    ...
    /**
     * 通道下所有传感器的信息，用户申请内存, nDevicesNum*sizeof(NET_IOTBOX_CHANNEL_DEVICE_INFO),参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_IOTBOX_CHANNEL_DEVICE_INFO}
    */
