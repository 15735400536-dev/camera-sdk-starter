...
public class NET_ANALYSE_TASK_MODULE extends SdkStructure {
	 ...
	 * 排除区域
	 */
    public	NetSDKLibStructure.NET_POLY_POINTS[] stuExcludeRegion = new NetSDKLibStructure.NET_POLY_POINTS[10];
	/**
	 * 排除区域数
	 */
	...
	public NET_ANALYSE_TASK_MODULE(){
		...
		for(int i=0;i<stuExcludeRegion.length;i++){
			stuExcludeRegion[i]=new NetSDKLibStructure.NET_POLY_POINTS();
		}
