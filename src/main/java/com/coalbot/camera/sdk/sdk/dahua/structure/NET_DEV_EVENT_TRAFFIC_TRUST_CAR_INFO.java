...
*/
public class NET_DEV_EVENT_TRAFFIC_TRUST_CAR_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 通道号
    */
    ...
    */
    ...
    /**
     * 登记的TrafficRedList信息,参见结构体定义 {@link NetSDKLibStructure.NET_TRAFFIC_LIST_RECORD}
    */
    public NetSDKLibStructure.NET_TRAFFIC_LIST_RECORD stuCarInfo = new NetSDKLibStructure.NET_TRAFFIC_LIST_RECORD();
    /**
     * 交通事件公共信息,参见结构体定义 {@link NetSDKLibStructure.EVENT_COMM_INFO}
    */
