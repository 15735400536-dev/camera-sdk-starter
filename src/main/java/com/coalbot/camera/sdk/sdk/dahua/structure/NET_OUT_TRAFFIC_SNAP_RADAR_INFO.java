 ...
 * @date 2020/12/14
 */
public class NET_OUT_TRAFFIC_SNAP_RADAR_INFO extends NetSDKLibStructure.SdkStructure {
	/**
	 * 结构体大小
	 * */
    public int              dwSize;
	 ...
	 * 虚警坐标点信息
	 * */
    public NetSDKLibStructure.NET_POINT[]      stuFakeAlarmPointInfo = (NetSDKLibStructure.NET_POINT[])new NetSDKLibStructure.NET_POINT().toArray(64);
	 /**
	  * 实际返回虚警点个数
	  * */
