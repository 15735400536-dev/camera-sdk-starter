...
*/
public class NET_OUT_GETONVIF_USERINFO_ALL_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 结构体大小
    */
    ...
    */
    ...
    /**
     * 用户信息列表(无法获取到密码信息),参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_ONVIF_USER_INFO}
    */
