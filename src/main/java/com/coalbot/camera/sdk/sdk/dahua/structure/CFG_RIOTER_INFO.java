...
*/
public class CFG_RIOTER_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 规则名称,不同规则不能重名
    */
    ...
    */
    ...
    /**
     * 对应1个或多个排除区域,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_EXCLUDE_REGION_INFO}
    */
    public NET_EXCLUDE_REGION_INFO[] stuExcludeRegions = new NET_EXCLUDE_REGION_INFO[20];
    /**
     * 主动巡视配置信息,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_PARTOL_LINKAGE_INFO}
    */
