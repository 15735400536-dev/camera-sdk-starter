 ...
 */
public class NET_VIDEOSTAT_SUMMARY_STEREO extends NetSDKLibStructure.SdkStructure {
	/**
	 * 时间
	 */
	...
	/**
	 * 数据类型 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.NET_EM_VS_DATA_TYPE}
	 */
    public int              emType;
	/**
	 * 目标实时检测位置统计
