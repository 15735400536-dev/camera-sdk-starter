...
*/
public class DEV_EVENT_PRESERVATION_INFO extends NetSDKLibStructure.SdkStructure {
/** 
通道号
*/
...
规则检测区域
*/
    public			NetSDKLibStructure.DH_POINT[] DetectRegion = (NetSDKLibStructure.DH_POINT[])new NetSDKLibStructure.DH_POINT().toArray(20);
/** 
...
*/
    public			NetSDKLibStructure.NET_MSG_OBJECT_EX2[] stuObjects = (NetSDKLibStructure.NET_MSG_OBJECT_EX2[])new NetSDKLibStructure.NET_MSG_OBJECT_EX2().toArray(128);
/** 
保留字节,留待扩展.
*/
