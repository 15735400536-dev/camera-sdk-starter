 ...
 * 外部接入探测器信息
*/
public class NET_ACCESSORY_EXTERNAL_SENSOR_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 外部防拆配置,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_ACCESSORY_TAMPER_INFO}
    */
