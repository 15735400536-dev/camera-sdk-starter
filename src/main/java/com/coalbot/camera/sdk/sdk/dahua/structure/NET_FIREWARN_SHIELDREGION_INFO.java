 ...
 * 火警屏蔽区域
*/
public class NET_FIREWARN_SHIELDREGION_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 屏蔽区使能
    */
    ...
    */
    ...
    /**
     * 屏蔽区多边形类型，多边形中每个顶点的坐标归一化到[0,8192]区间，最多16边形,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_POINT_EX}
    */
