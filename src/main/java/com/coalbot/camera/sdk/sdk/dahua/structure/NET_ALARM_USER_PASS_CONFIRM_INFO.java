...
public class NET_ALARM_USER_PASS_CONFIRM_INFO extends NetSDKLibStructure.SdkStructure {
    /**
    ...
    public int              nCount;
    /**
     * 进出方向(事件类型) {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_USER_PASS_TYPE}
     */
    public int              emType;
    /**
     * 保留字节
