 ...
 * @date 2020/10/19
 */
public class NET_MATCH_TWO_FACE_IN extends NetSDKLibStructure.SdkStructure {
    public int              dwSize;
    /**
     * 原图
     */
    ...
    /**
     * 比对方式, 不填默认图片对比,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_MATCH_TWO_FACE_TYPE}
    */
    public int              emType;
    /**
