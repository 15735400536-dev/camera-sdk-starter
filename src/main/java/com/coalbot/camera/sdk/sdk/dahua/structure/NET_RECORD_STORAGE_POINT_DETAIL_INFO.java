 ...
 * 录像/图片存储点配置详细信息
*/
public class NET_RECORD_STORAGE_POINT_DETAIL_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 本地工作目录组序号, -1表示未知
    */
    ...
    */
    public int              bCustom;
    /**
     * 断网续传上传顺序, bLocalForEmergency为TRUE时有效,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_STORAGE_POINT_ORDER_TYPE}
    */
    public int              emOrder;
    /**
     * 是否存储到USB设备
