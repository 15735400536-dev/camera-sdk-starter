...
import com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_CITIZENIDCARD_SEX_TYPE;

import static com.coalbot.camera.sdk.sdk.dahua.NetSDKLib.*;
 ...
 */
public class ALARM_CITIZEN_PICTURE_COMPARE_INFO extends NetSDKLibStructure.SdkStructure {
    /**
     * 通道号
     */
     ...
     * 居民姓名
     */
    public byte[]           szCitizen = new byte[NetSDKLibStructure.NET_COMMON_STRING_64];
    /**
     * 住址
     */
    public byte[]           szAddress = new byte[NetSDKLibStructure.NET_COMMON_STRING_256];
    /**
     * 证件号
     */
    public byte[]           szNumber = new byte[NetSDKLibStructure.NET_COMMON_STRING_64];
    /**
     * 签发机关
     */
    public byte[]           szAuthority = new byte[NetSDKLibStructure.NET_COMMON_STRING_256];
    /**
     * 出生日期(年月日)
     */
     ...
     * IC卡号
     */
    public byte[]           szCardNo = new byte[NetSDKLibStructure.NET_COMMON_STRING_32];
    /**
     * 手机号（比对时先输入手机号）
     */
    public byte[]           szCellPhone = new byte[NetSDKLibStructure.NET_COMMON_STRING_32];
    /**
    ...
    /**
     * 口罩状态 {@link NetSDKLibStructure.EM_MASK_STATE_TYPE}
     */
    public int              emMask;
    /**
     * 人脸质量评分
