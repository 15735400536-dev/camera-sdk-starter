 ...
 */
public class CFG_CAP_ACCESSCONTROL extends NetSDKLibStructure.SdkStructure {
	/**
	 * 门禁组数、
	 */
	 ...
	 * {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_CUSTOM_PASSWORD_ENCRYPTION_MODE}
	 */
    public int              emCustomPasswordEncryption;
	/**
	 * 是否支持信息功能 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_SUPPORTFINGERPRINT}
	 */
	...
	/**
	 * 是否支持门禁快速导入功能 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_SUPPORT_FAST_IMPORT_TYPE}
	 */
    public int              bSupportFastImport;
	/**
	 * 是否支持门禁快速复核功能{@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_SUPPORT_FAST_CHECK_TYPE}
	 */
	...
	/**
	 * 支持的梯控制方式类型的集合{@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_SUPPORT_LIFT_CONTROL_TYPES}
	 */
