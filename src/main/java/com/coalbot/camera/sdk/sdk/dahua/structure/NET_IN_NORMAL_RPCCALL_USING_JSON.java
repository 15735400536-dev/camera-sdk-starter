...
*/
public class NET_IN_NORMAL_RPCCALL_USING_JSON extends NetSDKLibStructure.SdkStructure
{
    /**
     * 此结构体大小,必须赋值
    */
    public int              dwSize;
    /**
     * 接口枚举,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_SUPPORT_RPC_TYPE}
    */
    public int              emType;
    /**
     * 参数类型， 0：结构体  1：json
