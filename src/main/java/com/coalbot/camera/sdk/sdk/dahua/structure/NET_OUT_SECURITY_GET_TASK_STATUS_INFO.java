...
*/
public class NET_OUT_SECURITY_GET_TASK_STATUS_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 此结构体大小,必须赋值
    */
    public int              dwSize;
    /**
     * 当前任务类型,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_SECURITY_TASK_TYPE}
    */
    public int              nTaskType;
    /**
     * 当前任务状态,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_SECURITY_TASK_STATUS}
    */
    public int              nStatus;
    /**
