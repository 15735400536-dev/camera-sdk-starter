 ...
 * 历史库人体信息
*/
public class NET_HISTORY_HUMAN_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
    ...
    */
    public int              emCap;
    /**
     * 是否有背包,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_HAS_BACK_BAG}
    */
    public int              emHasBackBag;
    /**
     * 是否带手提包,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_HAS_CARRIER_BAG}
    */
    public int              emHasCarrierBag;
    /**
     * 是否有肩包,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_HAS_SHOULDER_BAG}
    */
    public int              emHasShoulderBag;
    /**
     * 是否有斜跨包,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_HAS_MESSENGER_BAG}
    */
    public int              emMessengerBag;
    /**
     * 人体图片信息,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_HISTORY_HUMAN_IMAGE_INFO}
    */
    public NET_HISTORY_HUMAN_IMAGE_INFO stuImageInfo = new NET_HISTORY_HUMAN_IMAGE_INFO();
    /**
     * 图片信息,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_HISTORY_HUMAN_IMAGE_INFO}
    */
