 ...
 * 媒体信息――镜头传感器
*/
public class NET_MEDIA_SENSORINFO extends NetSDKLibStructure.SdkStructure
{
    /**
    ...
    */
    ...
    /**
     * 每个传感器类型的详细信息,有效个数由 nSensorTypeCount 指明,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_CAMERA_SENSORINFO}
    */
