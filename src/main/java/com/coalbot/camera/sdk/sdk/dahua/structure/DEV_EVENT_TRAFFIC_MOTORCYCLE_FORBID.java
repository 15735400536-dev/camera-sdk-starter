...
*/
public class DEV_EVENT_TRAFFIC_MOTORCYCLE_FORBID extends NetSDKLibStructure.SdkStructure
{
    /**
     * 通道号
    */
    ...
    */
    public double           PTS;
    /**
     * 事件发生的时间(单位是秒),参见结构体定义 {@link NetSDKLibStructure.NET_TIME_EX}
    */
    ...
    */
    public int              UTCMS;
    /**
     * 检测到的车牌信息,参见结构体定义 {@link NetSDKLibStructure.NET_MSG_OBJECT}
    */
    public NetSDKLibStructure.NET_MSG_OBJECT stuObject = new NetSDKLibStructure.NET_MSG_OBJECT();
    /**
     * 检测到的车辆信息,参见结构体定义 {@link NetSDKLibStructure.NET_MSG_OBJECT}
    */
    ...
    */
    ...
    /**
     * 交通车辆的数据库记录,参见结构体定义 {@link NetSDKLibStructure.DEV_EVENT_TRAFFIC_TRAFFICCAR_INFO}
    */
