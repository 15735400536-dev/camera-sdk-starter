 ...
 * @version 1.0
 * @description 事件类型
 * {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_EVENT_IVS_TYPE#EVENT_IVS_SHOP_SIGN_ABNORMAL}(店招异常事件)对应的数据块描述信息
 * @date 2020/11/17
 */
public class DEV_EVENT_SHOP_SIGN_ABNORMAL_INFO extends NetSDKLibStructure.SdkStructure {
    /**
     * 通道号
     */
    ...
    /**
     * 智能事件所属大类,对应枚举
     * {@link com.coalbot.camera.sdk.sdk.dahua.NetSDKLib.EM_CLASS_TYPE}
     */
