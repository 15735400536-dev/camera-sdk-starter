...
*/
public class CFG_HUMANTRAIT_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 规则名称,不同规则不能重名
    */
    ...
    */
    ...
    /**
     * 支持的目标检测类型列表,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_VIDEO_ANALYSE_HUMANFACE_TYPE}
    */
    ...
    */
    ...
    /**
     * 需检测的目标属性,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_FACEFEATURE_TYPE}
    */
