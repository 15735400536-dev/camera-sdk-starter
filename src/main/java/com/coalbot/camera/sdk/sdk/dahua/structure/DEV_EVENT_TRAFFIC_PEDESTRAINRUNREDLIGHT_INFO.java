 ...
 * @version 1.0
 * @description 事件类型
 * {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_EVENT_IVS_TYPE#EVENT_IVS_TRAFFIC_PEDESTRAINRUNREDLIGHT}
 * (交通-行人闯红灯事件)对应的数据块描述信息
 * @date 2020/10/14
 */
public class DEV_EVENT_TRAFFIC_PEDESTRAINRUNREDLIGHT_INFO extends NetSDKLibStructure.SdkStructure {
    /**
     * 通道号
     */
