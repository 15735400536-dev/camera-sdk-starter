 ...
 */
public class CFG_AREA_MODE_INFO extends NetSDKLibStructure.SdkStructure {
	/**
	 * 区域名称
	 */
	 ...
	 * 区域坐标
	 */
    public NetSDKLibStructure.CFG_POLYGON[] stuArea = new NetSDKLibStructure.CFG_POLYGON[20];
	/**
	...
	public CFG_AREA_MODE_INFO() {
		for (int i = 0; i < stuArea.length; i++) {
			stuArea[i] = new NetSDKLibStructure.CFG_POLYGON();
		}
	}
}
