...
*/
public class NET_IN_POST_LOGIN_TASK extends NetSDKLibStructure.SdkStructure
{
    /**
     * 赋值为结构体大小
    */
    ...
    */
    ...
    /**
     * 当emSpecCap为EM_LOGIN_SPEC_CAP_TCP时，需要获取的配置类型,此时获取的配置和拉流相关, 当为EM_TCP_LOGIN_CONFIG_TYPE_UNKNOWN时，码流通过TCP传输，为EM_TCP_LOGIN_CONFIG_TYPE_MULTICAST时，码流通过组播传输,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_TCP_LOGIN_CONFIG_TYPE}
    */
