...
*/
public class NET_OUT_MW_GET_WINDOW_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
    ...
    */
    ...
    /**
     * 解码通道信息列表,用户申请空间,用户申请列表个数和nVideoInfoNum一致,申请内存大小为sizeof(NET_MW_GET_WINDOW_INFO)*nVideoInfoNum,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_MW_GET_WINDOW_INFO}
    */
