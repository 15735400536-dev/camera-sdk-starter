 ...
 */
public class NET_IN_TRAFFICSTARTFINDSTAT extends NetSDKLibStructure.SdkStructure {
	/**
	 * 此结构体大小
	 */
    public int              dwSize;
	...
	/**
	 * 查询要求返回的统计信息粒度 默认按小时
	 * {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_GRANULARITY_STARTFIND_TYPE}
	 */
    public int              emGranularity;
	/**
	 * 统计方向查询条件 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_STARTFIND_DIRECTION}
	 */
