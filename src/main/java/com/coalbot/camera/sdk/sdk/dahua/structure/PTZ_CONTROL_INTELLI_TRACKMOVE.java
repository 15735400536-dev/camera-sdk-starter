...
*/
public class PTZ_CONTROL_INTELLI_TRACKMOVE extends NetSDKLibStructure.SdkStructure
{
    public int              dwSize;
    /**
     * 通道号
    ...
    */
    public int              nFlag;
    /**
     * 云台绝对移动位置,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.PTZ_LOCATION_SPACE_UNIT}
    */
    public PTZ_LOCATION_SPACE_UNIT stuPosition = new PTZ_LOCATION_SPACE_UNIT();
    /**
     * 云台运行速度,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.PTZ_LOCATION_SPEED_UNIT}
    */
    ...
    */
    ...
    /**
     * 跟踪物体信息,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.PTZ_LOCATION_TRACK_OBJECT}
    */
