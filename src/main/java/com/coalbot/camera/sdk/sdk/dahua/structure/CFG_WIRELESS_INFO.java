 ...
 */
public class CFG_WIRELESS_INFO extends NetSDKLibStructure.SdkStructure {
	/**
	 * 2G网络使能
	 */
    public int              bEnable;
	...
	/**
	 * 接入的2G网络名称 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_CFG_APN}
	 */
    public int              emAPN;
	/**
	 * 用户名
	...
	/**
	 * 每日流量控制策略 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_CFG_DAY3GFLUXTACTIC}
	 */
	...
	/**
	 * 流量报警策略 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_CFG_DAY3GFLUXACTION}
	 */
    ...
    public int              n3GFlux;
	/**
	 * 流量使用策略{@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_CFG_3GFLUXTACTIC}
	 */
	...
	/**
	 * 工作模式选择 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_CFG_WORKMODE}
	 */
