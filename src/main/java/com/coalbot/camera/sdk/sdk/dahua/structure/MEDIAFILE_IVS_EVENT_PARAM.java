...
*/
public class MEDIAFILE_IVS_EVENT_PARAM extends NetSDKLibStructure.SdkStructure
{
    /**
     * 结构体大小
    */
    ...
    */
    ...
    /**
     * 事件动作,参见枚举定义 {@link NetSDKLib.NET_CROSSREGION_ACTION_INFO}
    */
    public int              emAction;
    /**
     * 对象类型个数
    */
    ...
    /**
     * 规则触发的对象类型,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_MEDIAFILE_IVS_OBJECT}
    */
