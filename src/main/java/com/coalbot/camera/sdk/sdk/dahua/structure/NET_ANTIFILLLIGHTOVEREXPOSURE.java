 ...
 * 防补光过曝
*/
public class NET_ANTIFILLLIGHTOVEREXPOSURE extends NetSDKLibStructure.SdkStructure
{
    /**
     * 支持防补光过曝的目标类型,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_LC_TARGETMODE}
    */
