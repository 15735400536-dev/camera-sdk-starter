 ...
 */
public class NET_ALARM_MANUAL_TEST_INFO extends NetSDKLibStructure.SdkStructure {
	/**
	 事件动作 0:脉冲
	 */
    public			int            nAction;
    ...
    */
    ...
    /**
     * 事件发生的UTC时间，不带时区,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.NetSDKLibStructure.NET_TIME_EX}
    */
    public NetSDKLibStructure.NET_TIME_EX stuRealUTC = new NetSDKLibStructure.NET_TIME_EX();
    /**
     * RealUTC 是否有效，bRealUTC 为 TRUE 时，用 stuRealUTC，否则 stuRealUTC 字段无效(用原事件结构体中的 事件发生时间/事件触发时间(UTC) 字段)
    */
    public int              bRealUTC;
    /**
     * 区域信息,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_MANUAL_TEST_AREA_INFO}
    */
    public Pointer          pstuAreaInfo;
    /**
     * 文件信息,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_MANUAL_TEST_FILE_INFO}
    */
    public Pointer          pstuFilesInfo;
	/**
	 保留字节
	 */
    public			byte[]         szReserved = new byte[180-2*NetSDKLibStructure.POINTERSIZE];
