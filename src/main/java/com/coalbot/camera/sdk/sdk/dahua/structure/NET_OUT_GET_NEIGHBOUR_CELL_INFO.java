...
*/
public class NET_OUT_GET_NEIGHBOUR_CELL_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 此结构体大小,必须赋值
    */
    ...
    */
    ...
    /**
     * 获取蜂窝网络邻区信息数组，最多获取10个邻区信息,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_NeighbourCellInfo}
    */
