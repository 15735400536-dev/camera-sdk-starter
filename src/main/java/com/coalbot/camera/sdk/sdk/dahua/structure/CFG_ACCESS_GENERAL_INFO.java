...
import static com.coalbot.camera.sdk.sdk.dahua.constant.SDKStructureFieldLenth.MAX_ADDRESS_LEN;
import static com.coalbot.camera.sdk.sdk.dahua.constant.SDKStructureFieldLenth.MAX_PASSWORD_LEN;
 ...
 * @date 2021/2/7
 */
public class CFG_ACCESS_GENERAL_INFO extends NetSDKLibStructure.SdkStructure {
  /** 开门音频文件路径 */
  ...
  /** 门禁通道单双向配置,对应枚举{@link com.coalbot.camera.sdk.sdk.dahua.enumeration.CFG_ACCESS_PROPERTY_TYPE} */
   ...
   */
    ...
    */
    ...
    /**
     * AB互锁信息扩展,由用户申请内存,大小为sizeof(CFG_ABLOCK_INFO_EX),参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.CFG_ABLOCK_INFO_EX}
    */
    public Pointer          pstuABLockInfoEx;
  /** 保留字节 */
    public byte[]           szReserved = new byte[696-NetSDKLibStructure.POINTERSIZE];
