 ...
 */
public class NET_ALARM_USER extends NetSDKLibStructure.SdkStructure {
	/**
	 * 用户编号
	 */
    public byte[]           szID = new byte[32];
	/**
	 * 用户状态 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_GETUSERINFOBYCONDITION_USER_STATUS}
	 */
	...
	/**
	 * 用户的权限列表，数组值参考{@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_ALARM_USERAUTHORITY}
	 */
    public int[]            emAuthorityList = new int[32];
	/**
	 * 用户所在组 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_ALARM_USER_GROUP}
	 */
    public int              emGroup;
	/**
	 * 是否为保留用户，保留用户不可删除
	...
	/**
	 * 用户类型 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_GETUSERINFOBYCONDITION_USER_TYPE}
	 */
