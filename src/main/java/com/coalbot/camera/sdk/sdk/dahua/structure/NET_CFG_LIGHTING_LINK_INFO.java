 ...
 * 云台补光灯联动项
*/
public class NET_CFG_LIGHTING_LINK_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 使能
    */
    public int              bEnable;
    /**
     * 闪烁灯光类型,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.NET_EM_FILCKERLIGHT_TYPE}
    */
    public int              emFilckerLightType;
    /**
     * 灯光联动方式,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.NET_EM_LIGHTLINK_TYPE}
    */
    ...
    */
    ...
    /**
     * 白光灯联动时间段,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_CFG_TIME_SECTION}
    */
