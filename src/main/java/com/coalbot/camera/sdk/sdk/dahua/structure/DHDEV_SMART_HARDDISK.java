 ...
 */
public class DHDEV_SMART_HARDDISK extends NetSDKLibStructure.SdkStructure {
	/**
	 * 硬盘号
	 */
	 ...
	 */
    public DHDEV_SMART_VALUE[] smartValue = new DHDEV_SMART_VALUE[NetSDKLibStructure.MAX_SMART_VALUE_NUM];
