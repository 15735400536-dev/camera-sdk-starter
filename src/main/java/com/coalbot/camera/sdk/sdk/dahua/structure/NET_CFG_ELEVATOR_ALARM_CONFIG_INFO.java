...
*/
public class NET_CFG_ELEVATOR_ALARM_CONFIG_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 结构体大小, 必须赋值
    */
    public int              dwSize;
    /**
     * 每个通道的配置,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_CFG_ELEVATOR_ALARM_DEVICE_INFO}
    */
