...
*/
public class CFG_WRITE_ON_THE_BOARD_DETECTION_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 规则名称,不同规则不能重名
    */
    ...
    */
    ...
    /**
     * 系统联动特写模式, 为UNKNOWN时不下发,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_CLOSE_UP_MODE}
    */
    ...
    */
    ...
    /**
     * 联动码流类型,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_LINKAGE_STREAM_TYPE}
    */
