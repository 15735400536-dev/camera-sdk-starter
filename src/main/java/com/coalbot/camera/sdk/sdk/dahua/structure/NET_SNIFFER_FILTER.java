 ...
 * 抓包过滤规则
*/
public class NET_SNIFFER_FILTER extends NetSDKLibStructure.SdkStructure
{
    /**
     * 有效的stElemetsge个数
    */
    ...
    /**
     * 过滤五元组的数组,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_SNIFFER_FILTER_ELEMENT}
    */
