 ...
 * 单条测温规则信息
*/
public class NET_RADIOMETRY_MANAGER_RULE_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 测温点报警设置个数
    */
    ...
    /**
     * 测温点报警设置,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_ALARM_SETTING_INFO}
    */
    ...
    */
    public int              bEnable;
    /**
     * 本地参数配置,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_LOCAL_PARAMETERS_INFO}
    */
    ...
    */
    ...
    /**
     * 测温点坐标,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_POINT_EX}
    */
