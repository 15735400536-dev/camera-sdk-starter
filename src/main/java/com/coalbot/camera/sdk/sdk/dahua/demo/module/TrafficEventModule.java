...
public class TrafficEventModule {
	...
	public static boolean New_OpenStrobe() {
		NetSDKLibStructure.NET_CTRL_OPEN_STROBE openStrobe = new NetSDKLibStructure.NET_CTRL_OPEN_STROBE();
		...
		openStrobe.write();
		if (LoginModule.netsdk.CLIENT_ControlDeviceEx(LoginModule.m_hLoginHandle, NetSDKLibStructure.CtrlType.CTRLTYPE_CTRL_OPEN_STROBE, openStrobe.getPointer(), null, 3000)) {
	...
	public static void New_CloseStrobe() {
		NetSDKLibStructure.NET_CTRL_CLOSE_STROBE closeStrobe = new NetSDKLibStructure.NET_CTRL_CLOSE_STROBE();
        closeStrobe.nChannelId = 0;
        closeStrobe.write();
        if (LoginModule.netsdk.CLIENT_ControlDeviceEx(LoginModule.m_hLoginHandle, NetSDKLibStructure.CtrlType.CTRLTYPE_CTRL_CLOSE_STROBE, closeStrobe.getPointer(), null, 3000)) {
    ...
    public static boolean manualSnapPicture(int chn) {
		NetSDKLibStructure.MANUAL_SNAP_PARAMETER snapParam = new NetSDKLibStructure.MANUAL_SNAP_PARAMETER();
    	...
    	snapParam.write();
    	boolean bRet = LoginModule.netsdk.CLIENT_ControlDeviceEx(LoginModule.m_hLoginHandle, NetSDKLibStructure.CtrlType.CTRLTYPE_MANUAL_SNAP, snapParam.getPointer(), null, 5000);
    	if (!bRet) {
    ...
    public static boolean attachIVSEvent(int ChannelId, NetSDKLib.fAnalyzerDataCallBack m_AnalyzerDataCB) {
        ...
        m_hAttachHandle = LoginModule.netsdk.CLIENT_RealLoadPictureEx(LoginModule.m_hLoginHandle, ChannelId,  NetSDKLibStructure.EVENT_IVS_ALL,
