 ...
 * 目标识别联动报警通道信息
*/
public class NET_FACE_RECOGNITION_ALARM_CHANNEL extends NetSDKLibStructure.SdkStructure
{
    /**
     * 目标库ID
    */
    ...
    */
    ...
    /**
     * 联动报警输出通道信息,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_ALARM_OUT_CHANNEL_INFO}
    */
