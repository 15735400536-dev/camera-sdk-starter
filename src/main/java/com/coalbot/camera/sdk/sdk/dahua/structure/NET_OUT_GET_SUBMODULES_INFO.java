...
*/
public class NET_OUT_GET_SUBMODULES_INFO extends NetSDKLibStructure.SdkStructure
{
    public int              dwSize;
    /**
     * 返回的子模块数量
    */
    public int              nRetNum;
    /**
     * 子模块信息,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_SUBMODULES_INFO}
    */
    public NET_SUBMODULES_INFO[] stuSubModuleInfo = new NET_SUBMODULES_INFO[32];
    /**
     * 子模块扩展信息,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_SUBMODULES_INFO_EX}
    */
