 ...
 */
public class DEV_EVENT_HEAT_IMAGING_TEMPER_INFO extends NetSDKLibStructure.SdkStructure {
	/**
	 * 温度异常点名称 从测温规则配置项中选择
	 */
	 ...
	 * {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.NET_RADIOMETRY_RESULT}
	 */
    public int              emResult;
	/**
	 * 报警条件 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.NET_RADIOMETRY_ALARMCONTION}
	 */
    ...
    */
    ...
    /**
     * 最高温坐标点，相对坐标系，范围[0,8191],参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_POINT_EX2}
    */
    public NET_POINT_EX2    stHotPoint = new NET_POINT_EX2();
    /**
     * 最低温坐标点，相对坐标系，范围[0,8191],参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_POINT_EX2}
    */
