 ...
 * X光机集中判图时的开包信息
*/
public class NET_XRARY_UNPACKING_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 包裹标识
    */
    ...
    */
    ...
    /**
     * 主视角包裹内危险物品信息,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_INSIDE_OBJECT}
    */
    ...
    */
    ...
    /**
     * 侧视角包裹内危险物品信息,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_INSIDE_OBJECT}
    */
    ...
    */
    ...
    /**
     * 开包包裹图片信息,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_XRAY_UNPACKING_IMAGE_INFO}
    */
    ...
    */
    ...
    /**
     * 主视角包裹内危险物品信息,内存由NetSDK申请释放,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_INSIDE_OBJECT}
    */
    public Pointer          pstuMainViewInside;
    /**
     * 侧视角包裹内危险物品信息,内存由NetSDK申请释放,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_INSIDE_OBJECT}
    */
    ...
    */
    ...
    public byte[]           reserved = new byte[460-NetSDKLibStructure.POINTERSIZE*3];
