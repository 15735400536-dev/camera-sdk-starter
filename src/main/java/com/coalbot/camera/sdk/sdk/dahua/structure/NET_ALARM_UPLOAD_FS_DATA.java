 ...
 * 目标数据
*/
public class NET_ALARM_UPLOAD_FS_DATA extends NetSDKLibStructure.SdkStructure
{
    /**
     * 年龄,-1表示该字段数据无效
    */
    ...
    */
    public int              emBeard;
    /**
     * 戴眼镜状态,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_GLASS_STATE_TYPE}
    */
    public int              emGlass;
    /**
