 ...
 */
public class NET_BOAT_OBJECT extends NetSDKLibStructure.SdkStructure {
	/**
    ...
    public int              nSpeed;
	/**
	 * 物体动作支持类型 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_ACTION}
	 */
	 ...
	 * 包围盒(绝对坐标)
	 */
    public NetSDKLibStructure.NET_RECT stuOriginalBoundingBox = new NetSDKLibStructure.NET_RECT();
	/**
	 * 行驶方向 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_BOAT_DIRECTION}
	 */
    ...
    */
    ...
    /**
     * 载货状态,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_BOAT_CARGO_TYPE}
    */
