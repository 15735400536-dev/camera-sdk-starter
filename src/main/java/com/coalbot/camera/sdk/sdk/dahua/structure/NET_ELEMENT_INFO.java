...
*/
public class NET_ELEMENT_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 播放事件类型,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_VOICE_BROADCAST_EVENT_TYPE}
    */
    ...
    */
    ...
    /**
     * 语音播放内容数组,	本字段优先级高于Type和Content,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_VOICE_BROADCAST_INFO}
    */
