...
*/
public class DEV_EVENT_TRAFFIC_CAR_MEASUREMENT_INFO extends NetSDKLibStructure.SdkStructure {
/** 
通道号
*/
...
/** 
触发时机 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_TRIGGER_OCCUR_TYPE}
*/
...
卡片信息
*/
    public NetSDKLibStructure.EVENT_CARD_INFO stuCardInfo = new NetSDKLibStructure.EVENT_CARD_INFO();
/** 
车辆行驶方向(相对车道方向) {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_VEHICLE_DRIVING_DIRECTION}
*/
    public			int            emDrivingDirection;
/** 
交通信号灯类型 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_TRFAFFIC_LIGHT_TYPE}
*/
    public			int            emLightState;
/** 
开闸状态 {@link NetSDKLibStructure.EM_OPEN_STROBE_STATE}
*/
    public			int            emOpenStrobeState;
/** 
抓拍车的位置 {@link NetSDKLibStructure.EM_VEHICLE_DIRECTION}
*/
    public			int            emVehicleDirection;
/** 
主驾驶座位安全带状态 {@link NetSDKLibStructure.NET_SAFEBELT_STATE}
*/
    public			int            emMainSeat;
/** 
副驶座位安全带状态 {@link NetSDKLibStructure.NET_SAFEBELT_STATE}
*/
...
*/
    ...
    */
    ...
    /**
     * 车身信息扩展,参见结构体定义 {@link NetSDKLibStructure.NET_MSG_OBJECT_EX2}
    */
    public Pointer          pstuVehicleEx2;
/** 
保留字节
*/
    public			byte[]         byResersed = new byte[1020-NetSDKLibStructure.POINTERSIZE];
