package com.coalbot.camera.sdk.sdk.dahua.constant;


import com.coalbot.camera.sdk.sdk.dahua.structure.ALARM_SOLARCELL_SYSTEM_INFO;
...
public class SDK_ALARM_Ex_TYPE {
    ...
    /**
     * 无硬盘报警,对应结构体{@link com.coalbot.camera.sdk.sdk.dahua.structure.ALARM_NO_DISK_INFO}
     * 对应的回调接口{@link NetSDKLib.fMessCallBack#invoke(int, NetSDKLib.LLong, Pointer, int, String, NativeLong, Pointer)}
     * 对应的接口{@link NetSDKLib#CLIENT_StartListenEx(NetSDKLib.LLong)}
     */
