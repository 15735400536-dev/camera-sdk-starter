 ...
 * 事件详细信息
*/
public class NET_IVSEVENT_DETAIL_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 报警事件详情,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_IVSEVENT_DATA}
    */
    ...
    */
    ...
    /**
     * 图片信息数组,该接口只有emType、szPath两个字段有效,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_IMAGE_INFO_EX2}
    */
