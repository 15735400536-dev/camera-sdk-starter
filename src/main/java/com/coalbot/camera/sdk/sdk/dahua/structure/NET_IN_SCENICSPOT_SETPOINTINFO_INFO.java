 ...
 */
public class NET_IN_SCENICSPOT_SETPOINTINFO_INFO extends NetSDKLibStructure.SdkStructure {
	/**
	 * 结构体大小
	 */
    public int              dwSize;
	 ...
	 * 一级标题名称
	 */
    public byte[]           szTitleName = new byte[NetSDKLibStructure.MAX_COMMON_STRING_64];
	/**
	 * 一级标题名称类型
	 */
