 ...
 */
public class NET_OUT_GET_FILE_INFO_BY_PATH_INFO extends NetSDKLibStructure.SdkStructure {
	/**
	 此结构体大小,必须赋值
	 */
    public			int            dwSize;
	/**
	 文件上传状态 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_FILE_UPDATE_STATE}
	 */
    public			int            emState;
	/**
	 文件开始时间
