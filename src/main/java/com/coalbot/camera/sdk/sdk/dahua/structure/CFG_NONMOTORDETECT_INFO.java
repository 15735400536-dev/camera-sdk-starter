...
*/
public class CFG_NONMOTORDETECT_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 规则名称,不同规则不能重名
    */
    ...
    */
    ...
    /**
     * 支持的非机动车属性列表,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_CFG_NONMOTOR_FEATURE}
    */
