 ...
 * 水流速检测事件
*/
public class ALARM_WATER_SPEED_DETECTION_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 通道号
    */
    ...
    */
    public int              nEventID;
    /**
     * 事件发生时间,参见结构体定义 {@link NetSDKLibStructure.NET_TIME_EX}
    */
    public NetSDKLibStructure.NET_TIME_EX UTC = new NetSDKLibStructure.NET_TIME_EX();
    /**
     * 事件的数据类型,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.NETAEM_EVENT_TYPE}
    */
    ...
    */
    ...
    /**
     * 水流速度信息,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_WATER_SPEED_INFO}
    */
    ...
    */
    ...
    /**
     * 水流速状态,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_WATER_SPEED_STATUS}
    */
    public int              emStatus;
    /**
     * 原始图，近景,参见结构体定义 {@link NetSDKLibStructure.NET_INTELLIGENCE_IMAGE_INFO}
    */
    ...
    /**
     * 球机变到最小倍下的抓图,参见结构体定义 {@link NetSDKLibStructure.NET_INTELLIGENCE_IMAGE_INFO}
    */
