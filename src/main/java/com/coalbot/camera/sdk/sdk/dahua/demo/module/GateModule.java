...
public class GateModule {
    ...
    public static LLong realLoadPic(int ChannelId, NetSDKLib.fAnalyzerDataCallBack m_AnalyzerDataCB) {
		...
		LLong m_hAttachHandle = LoginModule.netsdk.CLIENT_RealLoadPictureEx(LoginModule.m_hLoginHandle, ChannelId,  NetSDKLibStructure.EVENT_IVS_ALL,
	...
	public static boolean insertCard(String cardNo, String userId, String cardName, String cardPwd,
		 ...
		 * 门禁卡记录集信息 
		 */
		NetSDKLibStructure.NET_RECORDSET_ACCESS_CTL_CARD accessCardInfo = new NetSDKLibStructure.NET_RECORDSET_ACCESS_CTL_CARD();
		 ...
		 * 记录集操作
		 */
		NetSDKLibStructure.NET_CTRL_RECORDSET_INSERT_PARAM insert = new NetSDKLibStructure.NET_CTRL_RECORDSET_INSERT_PARAM();
		insert.stuCtrlRecordSetInfo.emType = NetSDKLibStructure.EM_NET_RECORD_TYPE.NET_RECORD_ACCESSCTLCARD;   // 记录集类型
		...
		boolean bRet = LoginModule.netsdk.CLIENT_ControlDevice(LoginModule.m_hLoginHandle,
				NetSDKLibStructure.CtrlType.CTRLTYPE_CTRL_RECORDSET_INSERT, insert.getPointer(), 5000);
		insert.read();
		accessCardInfo.read();
	...
	public static boolean modifyCard(int recordNo, String cardNo, String userId, String cardName, String cardPwd,
		 ...
		 * 记录集操作
		 */
		NetSDKLibStructure.NET_CTRL_RECORDSET_PARAM update = new NetSDKLibStructure.NET_CTRL_RECORDSET_PARAM();
    	update.emType = NetSDKLibStructure.EM_NET_RECORD_TYPE.NET_RECORD_ACCESSCTLCARD;    // 记录集信息类型
    	update.pBuf = accessCardInfo.getPointer();
		
    	accessCardInfo.write();
		update.write();
		boolean bRet = LoginModule.netsdk.CLIENT_ControlDevice(LoginModule.m_hLoginHandle,
				NetSDKLibStructure.CtrlType.CTRLTYPE_CTRL_RECORDSET_UPDATE, update.getPointer(), 5000);
		update.read();
		accessCardInfo.read();
	...
	public static boolean deleteCard(int recordNo) {
		 ...
		 * 记录集操作
		 */
		NetSDKLibStructure.NET_CTRL_RECORDSET_PARAM msg = new NetSDKLibStructure.NET_CTRL_RECORDSET_PARAM();
    	msg.emType = NetSDKLibStructure.EM_NET_RECORD_TYPE.NET_RECORD_ACCESSCTLCARD;
    	msg.pBuf = new IntByReference(recordNo).getPointer();

    	msg.write();
    	boolean bRet = LoginModule.netsdk.CLIENT_ControlDevice(LoginModule.m_hLoginHandle,
				NetSDKLibStructure.CtrlType.CTRLTYPE_CTRL_RECORDSET_REMOVE, msg.getPointer(), 5000);
    	msg.read();
   ...
   /**
	...
	public static boolean clearCard() {
		 ...
		 */
		NetSDKLibStructure.NET_CTRL_RECORDSET_PARAM msg = new NetSDKLibStructure.NET_CTRL_RECORDSET_PARAM();
		msg.emType = NetSDKLibStructure.EM_NET_RECORD_TYPE.NET_RECORD_ACCESSCTLCARD;    // 门禁卡记录集信息类型
    	
		msg.write();
    	boolean bRet = LoginModule.netsdk.CLIENT_ControlDevice(LoginModule.m_hLoginHandle,
				NetSDKLibStructure.CtrlType.CTRLTYPE_CTRL_RECORDSET_CLEAR, msg.getPointer(), 5000);
    	msg.read();
    	if(!bRet){
	...
	public static boolean addFaceInfo(String userId, Memory memory) {
    	int emType = NetSDKLibStructure.EM_FACEINFO_OPREATE_TYPE.EM_FACEINFO_OPREATE_ADD;  // 添加
    	
    	/**
    	 *  入参
    	 */
		NetSDKLibStructure.NET_IN_ADD_FACE_INFO stIn = new NetSDKLibStructure.NET_IN_ADD_FACE_INFO();
    	 ...
    	 *  出参
    	 */
		NetSDKLibStructure.NET_OUT_ADD_FACE_INFO stOut = new NetSDKLibStructure.NET_OUT_ADD_FACE_INFO();
	...
	public static boolean modifyFaceInfo(String userId, Memory memory) {
    	int emType = NetSDKLibStructure.EM_FACEINFO_OPREATE_TYPE.EM_FACEINFO_OPREATE_UPDATE;  // 修改
    	
    	/**
    	 *  入参
    	 */
		NetSDKLibStructure.NET_IN_UPDATE_FACE_INFO stIn = new NetSDKLibStructure.NET_IN_UPDATE_FACE_INFO();
    	 ...
    	 *  出参
    	 */
		NetSDKLibStructure.NET_OUT_UPDATE_FACE_INFO stOut = new NetSDKLibStructure.NET_OUT_UPDATE_FACE_INFO();
    ...
    public static boolean deleteFaceInfo(String userId) {
    	int emType = NetSDKLibStructure.EM_FACEINFO_OPREATE_TYPE.EM_FACEINFO_OPREATE_REMOVE;
    	
    	/**
    	 * 入参
    	 */
		NetSDKLibStructure.NET_IN_REMOVE_FACE_INFO inRemove = new NetSDKLibStructure.NET_IN_REMOVE_FACE_INFO();
    	 ...
    	 *  出参
    	 */
		NetSDKLibStructure.NET_OUT_REMOVE_FACE_INFO outRemove = new NetSDKLibStructure.NET_OUT_REMOVE_FACE_INFO();
    ...
    public static boolean clearFaceInfo() {
    	int emType = NetSDKLibStructure.EM_FACEINFO_OPREATE_TYPE.EM_FACEINFO_OPREATE_CLEAR;  // 清除
    	
    	/**
    	 *  入参
    	 */
		NetSDKLibStructure.NET_IN_CLEAR_FACE_INFO stIn = new NetSDKLibStructure.NET_IN_CLEAR_FACE_INFO();
    	
    	/**
    	 *  出参
    	 */
		NetSDKLibStructure.NET_OUT_REMOVE_FACE_INFO stOut = new NetSDKLibStructure.NET_OUT_REMOVE_FACE_INFO();
    ...
    public static boolean findCard(String cardNo) {
		 ...
		 * 查询条件
		 */
		NetSDKLibStructure.FIND_RECORD_ACCESSCTLCARD_CONDITION findCondition = new NetSDKLibStructure.FIND_RECORD_ACCESSCTLCARD_CONDITION();
		 ...
		 */
		NetSDKLibStructure.NET_IN_FIND_RECORD_PARAM stIn = new NetSDKLibStructure.NET_IN_FIND_RECORD_PARAM();
		stIn.emType = NetSDKLibStructure.EM_NET_RECORD_TYPE.NET_RECORD_ACCESSCTLCARD;
		if(!cardNo.isEmpty()) {
		 ...
		 */
		NetSDKLibStructure.NET_OUT_FIND_RECORD_PARAM stOut = new NetSDKLibStructure.NET_OUT_FIND_RECORD_PARAM();
     ...
     * @return 返回具体的查询信息
     */
    public static NetSDKLibStructure.NET_RECORDSET_ACCESS_CTL_CARD[] findNextCard(int nFindCount) {
    	// 用于申请内存
		NetSDKLibStructure.NET_RECORDSET_ACCESS_CTL_CARD[] pstRecord = new NetSDKLibStructure.NET_RECORDSET_ACCESS_CTL_CARD[nFindCount];
		for(int i = 0; i < nFindCount; i++) {
			pstRecord[i] = new NetSDKLibStructure.NET_RECORDSET_ACCESS_CTL_CARD();
		}
		
		/**
		 *  CLIENT_FindNextRecord 接口入参
		 */
		NetSDKLibStructure.NET_IN_FIND_NEXT_RECORD_PARAM stNextIn = new NetSDKLibStructure.NET_IN_FIND_NEXT_RECORD_PARAM();
		 ...
		 */
		NetSDKLibStructure.NET_OUT_FIND_NEXT_RECORD_PARAM stNextOut = new NetSDKLibStructure.NET_OUT_FIND_NEXT_RECORD_PARAM();
		...
		if(LoginModule.netsdk.CLIENT_FindNextRecord(stNextIn, stNextOut, 5000)) {												
			...
			// 获取有用的信息
			NetSDKLibStructure.NET_RECORDSET_ACCESS_CTL_CARD[] pstRecordEx = new NetSDKLibStructure.NET_RECORDSET_ACCESS_CTL_CARD[stNextOut.nRetRecordNum];
			for(int i = 0; i < stNextOut.nRetRecordNum; i++) {
				pstRecordEx[i] = new NetSDKLibStructure.NET_RECORDSET_ACCESS_CTL_CARD();
