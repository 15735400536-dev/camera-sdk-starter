...
*/
public class NET_DEV_EVENT_SMART_MOTION_EQUIPMENT_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 通道号
    */
    ...
    */
    ...
    /**
     * 设备运行状况检测信息,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_SMART_MOTION_EQUIPMENT_OBJECT_INFO}
    */
    public NET_SMART_MOTION_EQUIPMENT_OBJECT_INFO[] stuObject = new NET_SMART_MOTION_EQUIPMENT_OBJECT_INFO[64];
    /**
     * 场景大图,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_SMART_MOTION_EQUIPMENT_SCENE_IMAGE_INFO}
    */
