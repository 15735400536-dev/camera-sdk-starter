...
*/
public class CFG_VIDEOIN_BACKLIGHT_BASE extends NetSDKLibStructure.SdkStructure {
/** 
背光模式 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_VIDEOIN_BACKLIGHT_MODE}
*/
    public			int            emMode;
/** 
背光补偿模式，当emMode == EM_BACKLIGHT_BACKLIGHT时有效 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_BACKLIGHT_MODE}
*/
    public			int            emBacklightMode;
/** 
背光补偿区域，当emBacklightMode == EM_BACKLIGHT_REGION时有效
*/
    public NetSDKLibStructure.CFG_RECT stuBacklightRegion = new NetSDKLibStructure.CFG_RECT();
/** 
...
/** 
SSA对比度调节模式，emMode==EM_BACKLIGHT_SSA时有效 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_INTENSITY_MODE}
*/
...
*/
    ...
    */
    ...
    /**
     * 强光抑制模式, emMode == EM_BACKLIGHT_GLAREINHIBITION时有效,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_GLARE_INHIBITION_MODE}
    */
