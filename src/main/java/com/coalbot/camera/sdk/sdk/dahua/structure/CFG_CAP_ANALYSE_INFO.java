 ...
 * @date 2021/01/08
 */
public class CFG_CAP_ANALYSE_INFO extends NetSDKLibStructure.SdkStructure {
	/**
	 * 支持的场景个数
	 */
	 ...
	 * 支持的场景列表
	 */
    public MaxNameByteArrInfo[] szSceneName = (MaxNameByteArrInfo[])new MaxNameByteArrInfo().toArray(NetSDKLibStructure.MAX_SCENE_LIST_SIZE);
	/**
	 * 每通道支持最大分析模块数
	 */
	 ...
	 */
    public int[]            dwRulesType = new int[NetSDKLibStructure.MAX_RULE_LIST_SIZE];
	/**
	 * 支持的最大标尺个数
	 */
	 ...
	 * 支持的特殊检测区属性
	 */
    public int[]            nSupportedSpecialDetectPropertys = new int[NetSDKLibStructure.EM_SEPCIALREGION_PROPERTY_TYPE.EM_SEPCIALREGION_PROPERTY_TYPE_NUM];
	/**
	 ...
	 * 支持的场景组合项列表
	 */
    public CFG_SUPPORTED_COMP[] stuSupportedComp = (CFG_SUPPORTED_COMP[])new CFG_SUPPORTED_COMP().toArray(NetSDKLibStructure.MAX_SUPPORTED_COMP_SIZE);
	/**
