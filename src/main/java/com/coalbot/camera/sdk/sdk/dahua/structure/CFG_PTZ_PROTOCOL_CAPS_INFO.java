...
import static com.coalbot.camera.sdk.sdk.dahua.constant.SDKStructureFieldLenth.MAX_PROTOCOL_NAME_LEN;
 ...
 * @date 2020/11/9
 */
public class CFG_PTZ_PROTOCOL_CAPS_INFO extends NetSDKLibStructure.SdkStructure {
    ...
    /**
     * 支持的支持的焦距模式掩码,从低位到高位依次数,见{@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_SUPPORT_FOCUS_MODE}
     */
     ...
     * 云台辅助功能名称列表
     */
    public Auxs[]           szAuxs = (Auxs[]) new Auxs().toArray(NetSDKLibStructure.CFG_COMMON_STRING_32);
    /**
     * 云台转动角度范围，单位：度
     */
    ...
    /**
     * 风扇能力,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.CFG_PTZ_FAN_CAPS}
    */
    public CFG_PTZ_FAN_CAPS stuPtzFan = new CFG_PTZ_FAN_CAPS();
    /**
     * 视窗加热器能力,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.CFG_WINDOW_HEATER_CAPS}
    */
    public CFG_WINDOW_HEATER_CAPS stuWindowHeater = new CFG_WINDOW_HEATER_CAPS();
    /**
     * 加热器能力,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.CFG_PTZ_HEATER}
    */
    public CFG_PTZ_HEATER   stuPtzHeater = new CFG_PTZ_HEATER();
    /**
     * 云台一键锁定,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.CFG_PTZ_ONE_CLICK_LOCK}
    */
