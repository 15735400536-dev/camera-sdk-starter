 ...
 * 单目标小图分割结果
*/
public class NET_GROUND_THING_DETECTION_MASK_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 宽度
    */
    ...
    */
    public int              nStride;
    /**
     * 遮罩数据,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_GROUND_THING_DETECTION_DATA}
    */
