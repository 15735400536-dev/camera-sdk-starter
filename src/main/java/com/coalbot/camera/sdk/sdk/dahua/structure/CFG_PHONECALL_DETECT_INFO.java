...
*/
public class CFG_PHONECALL_DETECT_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 规则名称,不同规则不能重名
    */
    ...
    */
    ...
    /**
     * 规则特定的尺寸过滤器，为提高规则判断精度,参见结构体定义 {@link NetSDKLibStructure.CFG_SIZEFILTER_INFO}
    */
    public NetSDKLibStructure.CFG_SIZEFILTER_INFO stuSizeFilter = new NetSDKLibStructure.CFG_SIZEFILTER_INFO();
    /**
