...
*/
public class ALARM_CITY_MOTORPARKING_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 通道号
    */
    ...
    */
    public int              nEventID;
    /**
     * 智能事件所属大类,参见枚举定义 {@link NetSDKLibStructure.EM_CLASS_TYPE}
    */
    ...
    */
    ...
    /**
     * 检测区域,参见结构体定义 {@link NetSDKLibStructure.NET_POINT}
    */
    ...
    */
    ...
    /**
     * 云台信息,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.PTZ_NORMALIZED_POSITION_UNIT}
    */
    public PTZ_NORMALIZED_POSITION_UNIT stuPtzPosition = new PTZ_NORMALIZED_POSITION_UNIT();
    /**
     * 车辆状态,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_CITYMOTOR_STATUS}
    */
