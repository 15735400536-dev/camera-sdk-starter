...
*/
public class NET_OUT_QUERY_MEDIA_FILE_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 此结构体大小,必须赋值
    */
    ...
    */
    ...
    /**
     * 文件信息,是一个数组，表示查询到的文件信息，CountResult = 0时，Info为空数组,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_QUERY_MEDIA_FILE}
    */
