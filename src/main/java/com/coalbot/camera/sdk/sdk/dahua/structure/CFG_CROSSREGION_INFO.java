 ...
 * @date 2021/07/06
 */
public class CFG_CROSSREGION_INFO extends NetSDKLibStructure.SdkStructure {
	 /**
     *  规则名称,不同规则不能重名
     */
     ...
     *  警戒区
     */
    public NetSDKLibStructure.CFG_POLYGON[] stuDetectRegion = (NetSDKLibStructure.CFG_POLYGON[]) new NetSDKLibStructure.CFG_POLYGON().toArray(NetSDKLibStructure.MAX_POLYGON_NUM);
    /**
     *  报警联动
     */
    ...
    /**
     * 绝对时间数组,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_ABSOLUTE_TIME_INFO}
    */
