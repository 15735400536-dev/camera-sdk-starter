 ...
 * @date 2021/01/11
 */
public class CFG_CAP_SCENE extends NetSDKLibStructure.SdkStructure {
	/**
	 * 场景名称
	 */
    ...
    */
    ...
    /**
     * 车辆密度,由用户申请，内存大小为sizeof(CFG_VEHICLES_DISTRI),参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.CFG_VEHICLES_DISTRI}
    */
    public Pointer          pstuVehiclesDistri;
    /**
     * 人群分布图,由用户申请，内存大小为sizeof(CFG_CROWD_DISTRI_MAP),参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.CFG_CROWD_DISTRI_MAP}
    */
