...
*/
public class CFG_IVS_HEATMAP_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 规则名称,不同规则不能重名
    */
    ...
    */
    ...
    /**
     * 警戒区,多边形类型，多边形中每个顶点的坐标归一化到[0,8192)区间,参见结构体定义 {@link NetSDKLibStructure.CFG_POLYGON}
    */
