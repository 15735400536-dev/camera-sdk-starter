 ...
 * 离线视频文件信息（第三方导入的文件）
*/
public class NET_OFFLINE_VIDEO_FILE_INFO extends NetSDKLibStructure.SdkStructure
{
    /**
     * 结构体大小
    */
    ...
    */
    ...
    /**
     * 远程文件访问协议类型,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_REMOTE_FILE_PROTOCOL_TYPE}
    */
    ...
    */
    ...
    /**
     * 分析文件的加密密钥对列表,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_ANALYSE_TASK_VIDEO_KEY_ENCRYPTION_KEYS}
    */
