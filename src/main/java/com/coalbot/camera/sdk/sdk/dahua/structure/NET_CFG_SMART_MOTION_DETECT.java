 ...
 * 智能动态检测配置
*/
public class NET_CFG_SMART_MOTION_DETECT extends NetSDKLibStructure.SdkStructure
{
    /**
     * 结构体大小
    */
    ...
    */
    public int              bEnable;
    /**
     * 动检敏感级别,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_SMART_MOTION_DETECT_SENSITIVITY_LEVEL}
    */
    public int              emMotionDetectSensitivityLevel;
    /**
     * 智能动态检测对象,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_SMART_MOTION_DETECT_OBJECT}
    */
    ...
    */
    ...
    /**
     * 智能动检检测区域信息,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_SMART_MOTION_DETECT_REGION}
    */
