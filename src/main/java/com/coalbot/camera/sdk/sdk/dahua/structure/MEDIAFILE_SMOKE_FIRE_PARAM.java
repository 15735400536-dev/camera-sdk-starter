...
*/
public class MEDIAFILE_SMOKE_FIRE_PARAM extends NetSDKLibStructure.SdkStructure
{
    /**
     * 结构体大小
    */
    ...
    */
    ...
    /**
     * 过滤规则,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_SMOKE_FIRE_FILTER}
    */
    ...
    */
    ...
    /**
     * UTC结束时间(标准UTC时间), 与stuStartTimeRealUTC配对使用，与(stuBeginTime, stuEndTime)互斥,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.NetSDKLibStructure.NET_TIME}
    */
