...
*/
public class ALARM_PROFILE_ALARM_TRANSMIT_INFO extends NetSDKLibStructure.SdkStructure
{
    public int              dwSize;
    /**
     * 通道号
    ...
    */
    ...
    /**
     * 报警源设备的类型,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_ALARM_TRANSMIT_DEV_SRC_TYPE}
    */
    public int              emDevSrcType;
    /**
     * 报警类型,参见枚举定义 {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_ALARM_TRANSMIT_ALARM_TYPE}
    */
    ...
    */
    public int              bRealUTC;
    /**
     * 事件发生的时间（标准UTC）,参见结构体定义 {@link NetSDKLibStructure.NET_TIME_EX}
    */
    public NetSDKLibStructure.NET_TIME_EX RealUTC = new NetSDKLibStructure.NET_TIME_EX();
    /**
     * 设备编号
    */
    ...
    */
    ...
    /**
     * 报警附带信息,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_PROFILE_ALARM_INFO}
    */
