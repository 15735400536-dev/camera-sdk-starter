 ...
 * 录像片段文件列表
*/
public class NET_OBJECT_MEDIA_FILE_INFOS extends NetSDKLibStructure.SdkStructure
{
    /**
     * 通道号，从0开始
    */
    ...
    */
    ...
    /**
     * 文件的UTC开始时间,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.NetSDKLibStructure.NET_TIME}
    */
    public NetSDKLibStructure.NET_TIME stuStartTimeRealUTC = new NetSDKLibStructure.NET_TIME();
    /**
     * 文件的UTC结束时间,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.NetSDKLibStructure.NET_TIME}
    */
