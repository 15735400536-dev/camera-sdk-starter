 ...
 */
public class NET_RADAR_NOTIFY_ALARMPOINTINFO extends NetSDKLibStructure.SdkStructure {
	/**
	 * 雷达报警点的数量
	 */
    ...
    */
    ...
    /**
     * 雷达报警点信息扩展，指针由SDK内部申请释放,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_RADAR_ALARMPOINT_INFO}
    */
    public Pointer          pstuAlarmPointEx;
    /**
     *  保留字节
     */
    public byte[]           byReserved = new byte[268-NetSDKLibStructure.POINTERSIZE];
}
