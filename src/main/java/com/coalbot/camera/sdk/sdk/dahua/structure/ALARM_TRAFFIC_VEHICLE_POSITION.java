...
/**
 * @author ： 260611
 * @description ： 车辆位置报警事件{@link NetSDKLibStructure#NET_ALARM_TRAFFIC_VEHICLE_POSITION}
 * @since ： Created in 2022/03/01 14:55
 */

public class ALARM_TRAFFIC_VEHICLE_POSITION extends NetSDKLibStructure.SdkStructure {
    /**
     ...
     * 事件名称
     */
    public byte[]           szEventName = new byte[NetSDKLibStructure.NET_COMMON_STRING_128];
    /**
     * 物体ID
     */
     ...
     * 车牌号
     */
    public byte[]           szPlateNumber = new byte[NetSDKLibStructure.NET_COMMON_STRING_128];
    /**
