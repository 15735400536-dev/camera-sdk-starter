 ...
 */
public class NET_OUT_MULTI_APPEND_TO_VEHICLE_REG_DB extends NetSDKLibStructure.SdkStructure {
    public  int             dwSize;                               // 结构体大小
    public int              nErrCodeNum;                          // 错误码个数
    public int              nRetErrCodeNum;                       // 返回的错误码数量
    /** {@link com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_VEHICLE_REG_DB_OPERATOR_ERRCODE} */
