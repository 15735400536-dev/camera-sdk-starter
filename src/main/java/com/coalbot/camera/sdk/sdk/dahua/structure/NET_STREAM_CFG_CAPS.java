...
import com.coalbot.camera.sdk.sdk.dahua.enumeration.EM_H264_PROFILE_RANK;
import com.coalbot.camera.sdk.sdk.dahua.enumeration.STREAM_RATE_TYPE;
import com.coalbot.camera.sdk.sdk.dahua.enumeration.TALK_CODING_TYPE;
 ...
 */
public class NET_STREAM_CFG_CAPS extends NetSDKLibStructure.SdkStructure {
    /**
     * 结构体大小
     */
    public int              dwSize;
     ...
     */
    public NetSDKLibStructure.NET_RESOLUTION_INFO[] stuResolutionTypes = new NetSDKLibStructure.NET_RESOLUTION_INFO[CFG_MAX_CAPTURE_SIZE_NUM];
    /**
     * 不同分辨率下帧率最大值
    ...
    */
    ...
    /**
     * 码流分辨率限制，限制界面和功能模块只能使用指定范围之内的分辨率，前提是设备支持该分辨率。是一个二维数组,第一级对应不同的码流,第二级对应支持的分辨率集合。二级数组为空表示不做限制，使用所有设备能提供的分辨率。,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_ENCODING_RESOLUTION_LIMIT}
    */
    public NET_ENCODING_RESOLUTION_LIMIT[] stuEncodingResolutionLimit = new NET_ENCODING_RESOLUTION_LIMIT[10];
    /**
     * 主辅码流分辨率组合限制，限制界面和功能模块只能使用指定范围之内的分辨率，前提是设备支持该分辨率。是一个二维数组,第一级是主辅码流分辨率组合的个数,第二级是主辅码流分辨率组合。二级数组为空表示没有限制，使用所有设备能提供的分辨率。,参见结构体定义 {@link com.coalbot.camera.sdk.sdk.dahua.structure.NET_ENCODING_RESOLUTION_LIMITEX}
    */
