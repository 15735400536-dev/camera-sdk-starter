 ...
 * @date 2020/11/06
 */
public class DEV_EVENT_STREET_SUNCURE_INFO extends NetSDKLibStructure.SdkStructure {
	/**
	 * 通道号
	 */
	 ...
	 * 保留字节,留待扩展
	 */
    public byte[]           byReserved = new byte[3228 - NetSDKLibStructure.POINTERSIZE * 3];
